...
@Component({
  selector: 'app-exited-employee',
  templateUrl: './exited-employee.component.html',
  // styleUrls: ['./confirmed-employee.component.scss']
})
export class ExitedEmployeeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.datatableConfig = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.apiService.getRecords_Status(dataTablesParameters,'Exited').subscribe(
          (resp) => {
