...
@Component({
  selector: 'app-probation-employee',
  templateUrl: './probation-employee.component.html',
  // styleUrls: ['./confirmed-employee.component.scss']
})
export class ProbationEmployeeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.datatableConfig = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.apiService.getRecords_Status(dataTablesParameters,'Probation').subscribe(
          (resp) => {
            
            // Ensure that departmentData is an array
            callback(resp)
          },
