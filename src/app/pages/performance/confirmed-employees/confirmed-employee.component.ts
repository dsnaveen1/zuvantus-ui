...
@Component({
  selector: 'app-confirmed-employee',
  templateUrl: './confirmed-employee.component.html',
  // styleUrls: ['./confirmed-employee.component.scss']
})
export class ConfirmedEmployeeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.datatableConfig = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        this.apiService.getRecords_Status(dataTablesParameters,'Active').subscribe(
          (resp) => {
